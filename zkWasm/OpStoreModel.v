...
Axiom p_op_store_len_modulus_gate :
  pgate etable
    (fun get =>
    (get (ops_cell Store) 0) *
        ((get len_modulus 0)
...
Axiom p_op_store_pick_helper_value_check :
  pgate etable
    (fun get =>
      (get (ops_cell Store) 0)
...
Axiom p_op_store_pick_value_size_check :
  pgate etable
    (fun get =>
    (get (ops_cell Store) 0) *
        (get is_four_bytes 0)
...
Axiom p_op_store_tailing_u16_decompose :
  pgate etable
    (fun get =>
      (get (ops_cell Store) 0)
...
Axiom p_op_store_allocated_address :
  pgate etable
    (fun get =>
    (get (ops_cell Store) 0) *
...
(* Unlimited Cells *)
Axiom unchanged_value_unlimited : isunlimited unchanged_value.
Axiom len_unlimited : isunlimited len.
Axiom len_modulus_unlimited : isunlimited len_modulus.
Axiom lookup_pow_modulus_unlimited : isunlimited lookup_pow_modulus.
Axiom lookup_pow_power_unlimited : isunlimited lookup_pow_power.

Axiom load_block_inner_pos_unlimited : isunlimited load_block_inner_pos.

Axiom store_base_unlimited : isunlimited store_base.
Axiom store_value_in_heap1_unlimited : isunlimited store_value_in_heap1.
Axiom store_value_in_heap2_unlimited : isunlimited store_value_in_heap2.
Axiom load_value_in_heap1_unlimited : isunlimited load_value_in_heap1.
Axiom load_value_in_heap2_unlimited : isunlimited load_value_in_heap2.
Axiom store_value_wrapped_unlimited : isunlimited store_value_wrapped.
