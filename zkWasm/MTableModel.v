...
Definition is64 c := forall i, 0 <= mtable_values c i < 2^64.
Definition isunlimited c := forall i, 0 <= mtable_values c i < field_order.
...
Axiom value_U64 : is64 value_u64_cell.

Axiom  encode_cell_unlimited :  isunlimited encode_cell.
Axiom  init_encode_cell_unlimited :  isunlimited init_encode_cell.
